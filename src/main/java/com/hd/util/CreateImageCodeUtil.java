...
public class CreateImageCodeUtil {
	...
	//标记随机字符类型
	private int flag = 1; // 1为英文字母或数字 2为中文字符
	// 验证码图片Buffer
	...
	public CreateImageCodeUtil(int width, int height, int flag) {
		this.width = width;
		this.height = height;
		this.flag = flag;
		creatImage();
	...
	public CreateImageCodeUtil(int width, int height, int flag, int codeCount) {
		this.width = width;
		this.height = height;
	...
	private void creatImage() {
		...
		String str1 = flag== 1? randomStr(codeCount) : randomStrByChina(codeCount);// 得到随机字符
	 ...
	 * @return
	 */
	public String randomStrByChina(int n) {
		// 设置备选汉字，剔除一些不雅的汉字
